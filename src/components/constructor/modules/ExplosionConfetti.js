 ...
 * @param {Number | undefined} options.rate Increases or decreases the frequency for particles. Don't set it too high. Can freeze your app
...
export default function ExplosionConfetti(
  ...
  return <mesh ref={groupRef} position={[0, 0, -4]} />;
}
